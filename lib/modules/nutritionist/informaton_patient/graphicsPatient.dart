...
class GraphicsPatientPage extends StatefulWidget {
  const GraphicsPatientPage({Key? key}) : super(key: key);

  @override
  State<GraphicsPatientPage> createState() => _GraphicsPatientPageState();
}

class _GraphicsPatientPageState extends State<GraphicsPatientPage> {
  @override
